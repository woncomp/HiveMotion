...
| [5 — Activation instrumentation](phase-5-activation-instrumentation.md) | Finer checkpoints plus a log-analysis script; measures Phases 1–4 | Complete (grid/native-show/bounds/batch checkpoints; tools/analyze-activation-logs.ps1) |
| [6 — Foreground validation](phase-6-foreground-validation.md) | Confirm multi-second activation stalls are gone; holistic interactive sign-off | Complete (verdict: stalls refuted for real input; 10/10 activations ≤365 ms) |
